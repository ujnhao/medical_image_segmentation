#!/usr/bin/python3
"""
    Create_at 20200414@wanghaohao
    Here are implementations for source segmentation trained on single modality
"""
import os
import time
import shutil
...
class Full_DRN(object):
    ...
    def restore(self, sess, model_path):
        ...
        saver = tf.train.Saver(tf.get_collection_ref("internal_batchnorm_variables"))
